#this tool Download / force Steam to use an older (32-bit) version.
#   (XD)
...
Write-Host "Steam 32-bit Glitch-3301 - " -ForegroundColor Cyan
Write-Host "===============================================================" -ForegroundColor DarkYellow
Write-Host ""
...
Write-Host '          \ \```             \   || Glitch_3301||' -ForegroundColor Cyan
Write-Host '          ;\ \o               ;  ||  shop_tek  ||' -ForegroundColor Cyan
